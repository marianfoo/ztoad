...
- Final CI after process-audit changes: head `7f36b64` passed GitHub Quality run `31097691676` plus both external abaplint checks; GitHub reported the PR merge state clean.
