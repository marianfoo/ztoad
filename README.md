...
For local checks, TDD, the two-system development workflow, native abapGit synchronization, and live validation, see [CONTRIBUTING.md](CONTRIBUTING.md), [docs/test-strategy.md](docs/test-strategy.md), and the current [baseline findings](docs/baseline-findings.md).
